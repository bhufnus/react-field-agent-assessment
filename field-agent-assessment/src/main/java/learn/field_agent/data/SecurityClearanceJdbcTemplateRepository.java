...
public class SecurityClearanceJdbcTemplateRepository implements SecurityClearanceRepository {
    ...
    // TODO: Delete a security clearance.
    //  (This requires a strategy.
    //  It's probably not appropriate to delete agency_agent records
    //  that depend on a security clearance.
    //  Only allow deletion if a security clearance key isn't referenced.)
    // TODO: this deletes but results in error
    @Override
    @Transactional
